#include "../Include/LuaScripting.hpp"
...
void LuaScripting::Test()
{
    ...
    if(erred)
         OutputDebugString( ( std::string ("Lua error: ") + luaL_checkstring(l, -1) + '\n' ).c_str() );
