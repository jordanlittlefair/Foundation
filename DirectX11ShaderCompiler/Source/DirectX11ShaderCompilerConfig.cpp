...
bool DirectX11ShaderCompilerConfig::Load( const std::string& directory, const std::string& filename )
{
...
const DirectX11ShaderCompilerConfig::ShaderData& DirectX11ShaderCompilerConfig::GetShaderData() const
{
	return _shader_data;
}